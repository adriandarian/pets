...
struct PetUpdateIntegrationSourceTests {
    ...
    func packagingKeepsThePermanentBundleIdentifierAndUsesVersionFiles() throws {
        ...
        let giftTierScript = try source("scripts/release_gift_tier.sh")
        ...
        #expect(runScript.contains("PetsReleaseGiftTier"))
        #expect(releaseScript.contains("PetsReleaseGiftTier"))
        #expect(giftTierScript.contains("selected_tier = \"routine\""))
        #expect(giftTierScript.contains("major|anniversary"))
